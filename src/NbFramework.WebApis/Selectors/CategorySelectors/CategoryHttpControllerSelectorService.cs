...
namespace NbFramework.WebApis.Selectors.CategorySelectors
{
    ...
    {
        string Select(IList<string> apiControllerFullNames, string category, string controller);
    }

    public class CategoryHttpControllerSelectorService : ICategoryHttpControllerSelectorService
    {
        public string Select(IList<string> apiControllerFullNames, string category, string controller)
        {
            ...
            //如果多条记录，按目录深浅猜测并返回长度最短的一个
            //FooController
            //A1.FooController
            //A1.B1.FooController
            //V2.A1.B1.FooController
